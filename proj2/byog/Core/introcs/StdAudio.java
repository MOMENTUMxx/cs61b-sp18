...
public final class StdAudio {
    ...
    private static byte[] readByte(String filename) {
        ...
        try {
            ...
            // try to read from URL
                ...
                URL url = edu.princeton.cs.introcs.StdAudio.class.getResource(filename);
    ...
    public static synchronized void play(final String filename) {
        ...
        InputStream is = edu.princeton.cs.introcs.StdAudio.class.getResourceAsStream(filename);
        if (is == null) {
    ...
    ***************************************************************************/
    ...
    private static double[] note(double hz, double duration, double amplitude) {
        int n = (int) (edu.princeton.cs.introcs.StdAudio.SAMPLE_RATE * duration);
        double[] a = new double[n+1];
        for (int i = 0; i <= n; i++)
            a[i] = amplitude * Math.sin(2 * Math.PI * i * hz / edu.princeton.cs.introcs.StdAudio.SAMPLE_RATE);
        return a;
    }
    ...
    public static void main(String[] args) {
        ...
        // 440 Hz for 1 sec
        double freq = 440.0;
        for (int i = 0; i <= edu.princeton.cs.introcs.StdAudio.SAMPLE_RATE; i++) {
            edu.princeton.cs.introcs.StdAudio.play(0.5 * Math.sin(2*Math.PI * freq * i / edu.princeton.cs.introcs.StdAudio.SAMPLE_RATE));
        }
        ...
        for (int i = 0; i < steps.length; i++) {
            ...
            edu.princeton.cs.introcs.StdAudio.play(note(hz, 1.0, 0.5));
        }


        // need to call this in non-interactive stuff so the program doesn't terminate
        // until all the sound leaves the speaker.
        edu.princeton.cs.introcs.StdAudio.close();
    }
}
