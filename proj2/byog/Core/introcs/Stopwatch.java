...
public class Stopwatch { 
    ...
    public static void main(String[] args) {
        ...
        edu.princeton.cs.introcs.Stopwatch timer1 = new edu.princeton.cs.introcs.Stopwatch();
        double sum1 = 0.0;
        for (int i = 1; i <= n; i++) {
            sum1 += Math.sqrt(i);
        }
        ...
        edu.princeton.cs.introcs.Stopwatch timer2 = new edu.princeton.cs.introcs.Stopwatch();
        double sum2 = 0.0;
        for (int i = 1; i <= n; i++) {
            sum2 += Math.pow(i, 0.5);
        }
