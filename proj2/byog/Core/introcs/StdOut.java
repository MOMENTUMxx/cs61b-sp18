...
public final class StdOut {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        // write to stdout
        edu.princeton.cs.introcs.StdOut.println("Test");
        edu.princeton.cs.introcs.StdOut.println(17);
        edu.princeton.cs.introcs.StdOut.println(true);
        edu.princeton.cs.introcs.StdOut.printf("%.6f\n", 1.0/7.0);
    }
