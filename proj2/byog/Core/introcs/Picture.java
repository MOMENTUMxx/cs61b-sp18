...
public final class Picture implements ActionListener {
   ...
   /**
     ...
     */
    public Picture(edu.princeton.cs.introcs.Picture picture) {
   ...
   /**
    ...
    public boolean equals(Object other) {
        ...
        edu.princeton.cs.introcs.Picture that = (edu.princeton.cs.introcs.Picture) other;
   ...
   /**
    ...
    public static void main(String[] args) {
        edu.princeton.cs.introcs.Picture picture = new edu.princeton.cs.introcs.Picture(args[0]);
