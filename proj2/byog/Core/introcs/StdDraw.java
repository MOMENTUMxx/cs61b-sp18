...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static edu.princeton.cs.introcs.StdDraw std = new edu.princeton.cs.introcs.StdDraw();
    ...
    ***************************************************************************/
    ...
    public static void setFont(Font font) {
        ...
        edu.princeton.cs.introcs.StdDraw.font = font;
    }
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = edu.princeton.cs.introcs.StdDraw.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
...
*/
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(edu.princeton.cs.introcs.StdDraw.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            edu.princeton.cs.introcs.StdDraw.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    ***************************************************************************/
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = edu.princeton.cs.introcs.StdDraw.userX(e.getX());
            mouseY = edu.princeton.cs.introcs.StdDraw.userY(e.getY());
            isMousePressed = true;
        }
    }
    ...
    *  as an argument. It can handle action keys
     ...
     */
    public static void main(String[] args) {
        edu.princeton.cs.introcs.StdDraw.square(0.2, 0.8, 0.1);
        edu.princeton.cs.introcs.StdDraw.filledSquare(0.8, 0.8, 0.2);
        edu.princeton.cs.introcs.StdDraw.circle(0.8, 0.2, 0.2);

        edu.princeton.cs.introcs.StdDraw.setPenColor(edu.princeton.cs.introcs.StdDraw.BOOK_RED);
        edu.princeton.cs.introcs.StdDraw.setPenRadius(0.02);
        edu.princeton.cs.introcs.StdDraw.arc(0.8, 0.2, 0.1, 200, 45);

        // draw a blue diamond
        edu.princeton.cs.introcs.StdDraw.setPenRadius();
        edu.princeton.cs.introcs.StdDraw.setPenColor(edu.princeton.cs.introcs.StdDraw.BOOK_BLUE);
        double[] x = { 0.1, 0.2, 0.3, 0.2 };
        double[] y = { 0.2, 0.3, 0.2, 0.1 };
        edu.princeton.cs.introcs.StdDraw.filledPolygon(x, y);

        // text
        edu.princeton.cs.introcs.StdDraw.setPenColor(edu.princeton.cs.introcs.StdDraw.BLACK);
        edu.princeton.cs.introcs.StdDraw.text(0.2, 0.5, "black text");
        edu.princeton.cs.introcs.StdDraw.setPenColor(edu.princeton.cs.introcs.StdDraw.WHITE);
        edu.princeton.cs.introcs.StdDraw.text(0.8, 0.8, "white text");
    }
