...
public final class In {
   ...
   /**
    ...
    public static int[] readInts(String filename) {
        return new edu.princeton.cs.introcs.In(filename).readAllInts();
    }
   ...
   /**
    ...
    public static double[] readDoubles(String filename) {
        return new edu.princeton.cs.introcs.In(filename).readAllDoubles();
    }
   ...
   /**
    ...
    public static String[] readStrings(String filename) {
        return new edu.princeton.cs.introcs.In(filename).readAllStrings();
    }
    ...
    public static int[] readInts() {
        return new edu.princeton.cs.introcs.In().readAllInts();
    }
   ...
   /**
    ...
    public static double[] readDoubles() {
        return new edu.princeton.cs.introcs.In().readAllDoubles();
    }
   ...
   /**
    ...
    public static String[] readStrings() {
        return new edu.princeton.cs.introcs.In().readAllStrings();
    }
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new edu.princeton.cs.introcs.In(urlName);
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new edu.princeton.cs.introcs.In("./InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new edu.princeton.cs.introcs.In("../stdlib/InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        in = new edu.princeton.cs.introcs.In("/n/fs/introcs/www/java/stdlib/InTest.txt");
        try {
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new edu.princeton.cs.introcs.In("G:\\www\\introcs\\stdlib\\InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
