...
public final class StdIn {
   ...
   /**
    ...
    private static void setScanner(Scanner scanner) {
        edu.princeton.cs.introcs.StdIn.scanner = scanner;
        edu.princeton.cs.introcs.StdIn.scanner.useLocale(LOCALE);
    }
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        String s = edu.princeton.cs.introcs.StdIn.readString();
        StdOut.println("Your string was: " + s);
        StdOut.println();

        StdOut.print("Type an int: ");
        int a = edu.princeton.cs.introcs.StdIn.readInt();
        StdOut.println("Your int was: " + a);
        StdOut.println();

        StdOut.print("Type a boolean: ");
        boolean b = edu.princeton.cs.introcs.StdIn.readBoolean();
        StdOut.println("Your boolean was: " + b);
        StdOut.println();

        StdOut.print("Type a double: ");
        double c = edu.princeton.cs.introcs.StdIn.readDouble();
