...
public class StdArrayIO {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        double[] a = edu.princeton.cs.introcs.StdArrayIO.readDouble1D();
        edu.princeton.cs.introcs.StdArrayIO.print(a);
        StdOut.println();

        // read and print a matrix of doubles
        double[][] b = edu.princeton.cs.introcs.StdArrayIO.readDouble2D();
        edu.princeton.cs.introcs.StdArrayIO.print(b);
        StdOut.println();

        // read and print a matrix of doubles
        boolean[][] d = edu.princeton.cs.introcs.StdArrayIO.readBoolean2D();
        edu.princeton.cs.introcs.StdArrayIO.print(d);
        StdOut.println();
    }
